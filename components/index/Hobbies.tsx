function Hobbies() {
  const listStyle =
    "text-gray-700 list-disc sm:text-lg md:text-xl dark:text-gray-300 p-1";
      ...
      <div className="flex flex-col md:flex-row w-full justify-start items-start ml-0 sm:ml-12 md:items-center">
        <div className="grid flex-grow rounded-box place-items-center">
          <div className="flex flex-col">
            <h1 className="text-2xl lg:text-4xl text-yellow-700 dark:text-green-500 normal-case mb-2">
              Hobbies
            </h1>
